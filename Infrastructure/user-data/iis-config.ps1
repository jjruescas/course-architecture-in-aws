...
Write-Output "---------------------------------------"
Write-Output "Cloning the Repo from Github..."
...
cd "c:\course-architecture-in-aws\ConfigurationManagement\Powershell-DSC\2-Refactoring_DSC\"
.\DSC-WebServer.ps1

Write-Output "DSC Executed"
